...
import br.ufes.inf.s2cvv.core.application.InstallSystemService;
...
public class InstallSystemController extends JSFController {
	...
	/** Getter for admin. */
	public Priest getAdmin() {
		return admin;
	}

	/** Getter for config. */
	public S2CVVConfiguration getConfig() {
		return config;
	}
...
//	}
	...
	public String saveConfig() {
		...
		logger.log(Level.FINEST, "Received input data:\n\t- config.institutionAcronym = {0}", config.getParishAcronym());
